...
console.group('_util.copy()')
    ...
    s2.status = '2'
    s2.channel.name = '新的组织'
    s2.channel.saleChannel[0].name = '新的销售组织'
    console.log(s1)     // 不变
    console.log(s2)     // {
                        //     id: 'a',
                        //     status: '2',
    ...
    var s2 = _util.copy(s1)
    s2.push({ id: 'b' })
    s2[0].channel.name = '新的组织'
    s2[0].channel.saleChannel[0].name = '新的销售组织'
    console.log(s1)     // 不变
    console.log(s2)     // [
                        //     {
                        //         id: 'a',
...
console.group('_util.extend()')
    ...
    _util.extend(obj, obj2, obj3)
    obj3.age = '50'
    obj2.channel.code = 'new code'
    console.log(obj)   // { name: "guang", age: "23", channel: { code: 'a' } }
console.groupEnd()
...
_util.object.assign(obj, obj2, obj3)
obj3.age = '50'
obj2.channel.code = 'new code'
console.group('_util.object.assign()')
    console.log(obj)   // { name: "guang", age: "23", channel: { code: 'new code' } }
console.groupEnd()
